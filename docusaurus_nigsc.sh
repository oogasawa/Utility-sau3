...
java -jar target/Utility-sau3-1.1.0-fat.jar docusaurus:index -c nigsc_ja.conf
...
java -jar target/Utility-sau3-1.1.0-fat.jar docusaurus:index -c nigsc_en.conf
