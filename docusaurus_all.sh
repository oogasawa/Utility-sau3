...
java -jar target/Utility-sau3-1.0.0-fat.jar docusaurus:index -c docusaurus_ja.conf
...
java -jar target/Utility-sau3-1.0.0-fat.jar docusaurus:index -c docusaurus_en.conf
